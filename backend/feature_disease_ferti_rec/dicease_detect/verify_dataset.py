...
# folder_labels = set(os.listdir(folder_path))
# csv_labels = set(df['label'])

# # Check label matches
# if csv_labels.issubset(folder_labels):
#     print("All labels in the CSV file match folder names.")
# else:
#     print("Mismatch found between labels in CSV and folder structure!")
...
# else:
#     print("All images listed in the CSV file exist in the folders.")
