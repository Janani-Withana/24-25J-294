...
# model = tf.keras.models.load_model('final_model.h5')  # Path to your saved model
...
#     img = image.load_img(img_path, target_size=(224, 224))  # Adjust size to match your model input
#     img_array = image.img_to_array(img) / 255.0  # Normalize image pixels to [0, 1]
...
#     predicted_class_idx = np.argmax(prediction)  # Get the class index with highest probability
...
#         print(f"Predicted class (disease): {predicted_class}")
