...
#     Dense(10, activation='softmax')  # 10 classes for the diseases
# ])
...
# # Train the model
# history = model.fit(
#     X_train, y_train_encoded,  # Use encoded labels
#     validation_data=(X_val, y_val_encoded),  # Use encoded validation labels
#     epochs=20,
#     batch_size=32,
...
# # Evaluate the model
# test_loss, test_accuracy = model.evaluate(X_test, y_test_encoded)  # Use encoded test labels
